      ...
      ">
        ...
        ">
            <div style="text-align: center; margin-bottom: 32px;">
                ...
                <h2 class="responsive-title mobile-text" style="color: white !important; font-size: 30px; font-weight: 900 !important; text-transform: uppercase !important; -webkit-text-fill-color: white !important; margin: 16px 0; word-wrap: break-word; overflow-wrap: break-word; hyphens: auto;">Đặt vé thành công</h2>
                <p class="mobile-text" style="margin-top: 16px; font-size: 16px; line-height: 1.6; text-align: left; opacity: 0.9; color: white !important; -webkit-text-fill-color: white !important;">
                    ...
                    Cảm ơn bạn đã đặt vé thành công! Hệ thống đã ghi nhận đơn hàng của bạn và sẽ gửi vé điện tử trong thời gian sớm nhất.
            ...
            <div style="margin-bottom: 24px; padding: 16px; background-color: rgba(255,255,255,0.08); border-radius: 12px;">
                ...
                <div class="info-row" style="display: flex; justify-content: space-between; padding: 6px 0;">
                    <p class="mobile-text"><strong style="color: white !important; -webkit-text-fill-color: white !important;">Tổng tiền: </strong><span style="color: white !important; -webkit-text-fill-color: white !important;">${data.orderInfo.totalAmount.toLocaleString('vi-VN')} VND</span></p>
                </div>
            </div>

            <div style="margin-bottom: 24px; padding: 16px; background-color: rgba(255,255,255,0.08); border-radius: 12px;">
                <h3 class="mobile-heading" style="margin-top: 0; color: #ffb347 !important; -webkit-text-fill-color: #ffb347 !important;">Chi tiết vé đã đặt</h3>
            ...
            <div style="margin-bottom: 24px; padding: 16px; background-color: rgba(255,255,255,0.08); border-radius: 12px;">
                <h3 class="mobile-heading" style="margin-top: 0; color: #ffb347 !important; -webkit-text-fill-color: #ffb347 !important;">Thông tin thanh toán</h3>
                <div class="info-row" style="display: flex; justify-content: space-between; padding: 6px 0; border-bottom: 1px solid rgba(255,255,255,0.1);">
                    <p class="mobile-text"><strong style="color: white !important; -webkit-text-fill-color: white !important;">Trạng thái: </strong><span class="mobile-status-success" style="color: #4ade80 !important; -webkit-text-fill-color: #4ade80 !important;">Đã thanh toán</span></p>
                </div>
                <div class="info-row" style="display: flex; justify-content: space-between; padding: 6px 0;">
                    <p class="mobile-text"><strong style="color: white !important; -webkit-text-fill-color: white !important;">Vé điện tử: </strong><span class="mobile-status-warning" style="color: #fbbf24 !important; -webkit-text-fill-color: #fbbf24 !important;">Đang xử lý</span></p>
                </div>
            </div>
