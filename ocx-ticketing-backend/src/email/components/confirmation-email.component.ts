      ...
      ">
        ...
        ">
            <div style="text-align: center; margin-bottom: 32px;">
                ...
                <h2 style="color: white !important; font-size: 40px; font-weight: 900 !important; text-transform: uppercase !important;">Đặt vé thành công</h2>
            ...
            <div style="margin-bottom: 24px; padding: 16px; background-color: rgba(255,255,255,0.08); border-radius: 12px;">
                ...
                <div class="info-row" style="display: flex; justify-content: space-between; padding: 6px 0;">
                    <strong style="color: white !important;">Tổng tiền : </strong><span style="color: white !important;">${data.orderInfo.totalAmount.toLocaleString('vi-VN')} VND</span>
                </div>
            </div>

            <div style="margin-bottom: 24px; padding: 16px; background-color: rgba(255,255,255,0.08); border-radius: 12px;">
                <h3 style="margin-top: 0; color: #ffb347 !important;">Chi tiết vé đã đặt</h3>
            ...
            <div style="margin-bottom: 24px; padding: 16px; background-color: rgba(255,255,255,0.08); border-radius: 12px;">
                <h3 style="margin-top: 0; color: #ffb347 !important;">Thông tin thanh toán</h3>
                <div class="info-row" style="display: flex; justify-content: space-between; padding: 6px 0; border-bottom: 1px solid rgba(255,255,255,0.1);">
                    <strong style="color: white !important;">Trạng thái : </strong><span style="color: #4ade80 !important;">✅ Đã thanh toán</span>
                </div>
                <div class="info-row" style="display: flex; justify-content: space-between; padding: 6px 0;">
                    <strong style="color: white !important;">Vé điện tử : </strong><span style="color: #fbbf24 !important;">⏳ Đang xử lý</span>
                </div>
            </div>
